...
namespace Simulator.Shared.NuevaSimlationconQwen.Equipments.Tanks.ProcessWipTankForLines.States.InletStates.StatesForTankSKIDs
{
    ...
    public class RawMaterialTankInletLolevelState : RawMaterialTankInletState, ITankOuletStarved
    {
        ...
        public RawMaterialTankInletLolevelState(ProcessRawMaterialTank tank) : base(tank)
        {
            ...
            AddTransition<RawMaterialTankInletFillingState>(tank=> tank.IsTankInLoLevel());
        }
