...
namespace Simulator.Shared.Models.HCs.Conectors
{
    ...
    {
        public override string EndPointName => StaticClass.Conectors.EndPoint.CreateUpdateInletConnectors;
   
    }
    public class OutletConnectorDTO : ConectorDTO
    {
        public override string EndPointName => StaticClass.Conectors.EndPoint.CreateUpdateOuletConnectors;
    }
    public class ConectorDTO : BaseResponse, IMessageResponse, IRequest
    {
        public virtual string EndPointName => string.Empty;

        public string Legend => Name;

        public string ActionType => Id == Guid.Empty ? "created" : "updated";
        public string ClassName => StaticClass.Conectors.ClassName;
