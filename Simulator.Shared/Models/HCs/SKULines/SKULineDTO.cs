...
{
    public class SKULineDTO : BaseResponse, IMessageResponse, IRequest
    {
        public string EndPointName => StaticClass.SKULines.EndPoint.CreateUpdate;

        public string Legend => Name;

        public string ActionType => Id == Guid.Empty ? "created" : "updated";
        public string ClassName => StaticClass.SKULines.ClassName;
