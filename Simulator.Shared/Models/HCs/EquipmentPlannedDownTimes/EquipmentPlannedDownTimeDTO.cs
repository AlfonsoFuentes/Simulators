...
{
    public class EquipmentPlannedDownTimeDTO : BaseResponse, IMessageResponse, IRequest
    {
        public string EndPointName => StaticClass.EquipmentPlannedDownTimes.EndPoint.CreateUpdate;

        public string Legend => Name;

        public string ActionType => Id == Guid.Empty ? "created" : "updated";
        public string ClassName => StaticClass.EquipmentPlannedDownTimes.ClassName;
