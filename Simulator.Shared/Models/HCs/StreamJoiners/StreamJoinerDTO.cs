...
{
    public class StreamJoinerDTO: BaseEquipmentDTO, IMessageResponse, IRequest
    {
        public string EndPointName => StaticClass.StreamJoiners.EndPoint.CreateUpdate;

        public string Legend => Name;

        public string ActionType => Id == Guid.Empty ? "created" : "updated";
        public string ClassName => StaticClass.StreamJoiners.ClassName;
