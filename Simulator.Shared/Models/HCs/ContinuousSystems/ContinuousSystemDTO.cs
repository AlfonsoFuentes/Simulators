...
{
    public class ContinuousSystemDTO: BaseEquipmentDTO, IMessageResponse, IRequest
    {
        public string EndPointName => StaticClass.ContinuousSystems.EndPoint.CreateUpdate;

        public string Legend => Name;

        public string ActionType => Id == Guid.Empty ? "created" : "updated";
        public string ClassName => StaticClass.ContinuousSystems.ClassName;
