...
{
    public partial class ProcessFlowDiagram
    {
        [Parameter]
        ...
        //private NewBaseEquipment? selectedEquipment;
        //private NewBaseEquipment? highlightedEquipment;
        ...
        //    var equipmentList = Simulation.SimulationEquipments;
        ...
        //private void GenerateConnections(List<NewBaseEquipment> equipmentList)
        //{
        //    connections.Clear();
        ...
        //        foreach (var outlet in highlightedEquipment.ConnectedOutletEquipments)
        //        {
        ...
        //        foreach (var inlet in highlightedEquipment.ConnectedInletEquipments)
        //        {
        ...
        //private string GetEquipmentType(NewBaseEquipment equipment)
        //{
        //    return equipment.EquipmentType switch
        //    {
        //        ProccesEquipmentType.Line => "Línea",
        //        ProccesEquipmentType.Tank => "Tanque",
        //        ProccesEquipmentType.Pump => "Bomba",
        //        ProccesEquipmentType.Mixer => "Mezclador",
        //        ProccesEquipmentType.ContinuousSystem => "SKID",
        //        ProccesEquipmentType.Operator => "Operador",
        ...
        //        GenerateConnections(Simulation?.SimulationEquipments!);
        //    }
        //    StateHasChanged();
        //}

        //bool LoadingSimulation = false;
        //public void AnalizeProcess()
        //{
        //    if (Simulation == null) return;
        //    Simulation.AnalyzeProductionCapabilities();
      
        //    StateHasChanged();
        //}
        //public void CleanAnalizeProcess()
        //{
        //    if (Simulation == null) return;
        //    Simulation.CleanAnalysisResults();
        ...
        //public int TotalEquipmentCount => Simulation?.SimulationEquipments.Count ?? 0;
        ...
        //    public NewBaseEquipment FromEquipment { get; set; } = null!;
        //    public NewBaseEquipment ToEquipment { get; set; } = null!;
        ...
        //private void PositionEquipment(List<NewBaseEquipment> equipmentList)
        //{
        ...
        //private void PositionColumn1RawMaterialTanks(List<NewBaseEquipment> equipmentList, Dictionary<Guid, (double X, double Y)> positionedEquipment, int minX, int groupWidth)
        //{
        //    double group1StartX = minX;
        //    double currentY = START_Y;
        //    var rawMaterialTanks = equipmentList.OfType<BaseTank>()
        //        .Where(t => (t is RawMaterialTank) ||(t is BackBoneRawMaterialTank))
        ...
        //    var pumpToTanksMap = new Dictionary<BasePump, List<BaseTank>>();

        //    foreach (var tank in rawMaterialTanks)
        //    {
        //        var associatedPumps = tank.ConnectedOutletEquipments.OfType<BasePump>().ToList();
        //        foreach (var pump in associatedPumps)
        //        {
        //            if (!pumpToTanksMap.ContainsKey(pump))
        //                pumpToTanksMap[pump] = new List<BaseTank>();
        ...
        //    }
        //}
        //private void PositionColumn2MixersAndSkidsWithOperators(List<NewBaseEquipment> equipmentList, Dictionary<Guid, (double X, double Y)> positionedEquipment, int minX, int groupWidth)
        //{
        ...
        //    var mixers = equipmentList.OfType<BaseMixer>().OrderBy(m => m.Name).ToList();
        //    var skids = equipmentList.OfType<BaseSKID>().OrderBy(s => s.Name).ToList();
        //    var mixerAndSkidEquipment = new List<NewBaseEquipment>();
        //    mixerAndSkidEquipment.AddRange(mixers);
        //    mixerAndSkidEquipment.AddRange(skids);
        ...
        //        if (equipment is BaseMixer mixer)
        //        {
        //            var connectedOperators = equipmentList.OfType<BaseOperator>()
        //                .Where(op => op.ConnectedOutletEquipments.Contains(mixer))
        //                .ToList();
        ...
        //        var associatedPumps = equipment.ConnectedOutletEquipments.OfType<BasePump>().ToList();
        ...
        //    var unpositionedOperators = equipmentList.OfType<BaseOperator>()
        ...
        //private void PositionColumn4WipTanks(List<NewBaseEquipment> equipmentList, Dictionary<Guid, (double X, double Y)> positionedEquipment, int minX, int groupWidth)
        //{
        ...
        //    var wipTanks = equipmentList.OfType<WIPTank>()
        //        .Where(t => t.FluidToStorage == FluidToStorage.ProductBackBone)
        //        .OrderBy(t => t.Name).ToList();
        ...
        //            var associatedLines = pump.ConnectedOutletEquipments.OfType<BaseLine>().ToList();
        ...
        //            var pumpLines = singlePump.ConnectedOutletEquipments.OfType<BaseLine>().ToList();
        ...
        //            foreach (var pump in associatedPumps)
        //            {
        //                var pumpLines = pump.ConnectedOutletEquipments.OfType<BaseLine>().ToList();
        ...
        //private void PositionUnpositionedEquipment(List<NewBaseEquipment> equipmentList, Dictionary<Guid, (double X, double Y)> positionedEquipment)
        //{
        ...
        //private void CreateEquipmentNodes(List<NewBaseEquipment> equipmentList, Dictionary<Guid, (double X, double Y)> positionedEquipment)
        //{
        ...
        //            {
        //                RawMaterialTank => new RawTankNode(),
        //                WIPForProductBackBone or BackBoneRawMaterialTank => new WipTankNode(),
        //                BaseMixer => new MixerNode(),
        //                BasePump => new PumpNode(),
        //                BaseLine => new LineNode(),
        //                BaseTank => new WipTankNode(),
        //                BaseOperator => new OperatorNode(), // Nuevo tipo
